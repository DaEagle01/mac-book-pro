...
ssdMid.addEventListener("click", function () {
  ...
  totalCost =
    Number(totalPrice.innerText) + parseFloat(extraStorageCost.innerText);
  totalPrice.innerText = totalCost;
  totalOut.innerText = totalCost;
});
...
expressDelivery.addEventListener("click", function () {
  ...
  totalCost =
    Number(totalPrice.innerText) + parseFloat(expressDeliveryCost.innerText);
  totalPrice.innerText = totalCost;
  totalOut.innerText = totalCost;
});
...
promoButton.addEventListener("click", function () {
  if (input.value == "stevekaku") {
    let afterPromoApply = parseInt(totalOut.innerText);
